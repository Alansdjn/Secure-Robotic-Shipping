...
# then: put pictures of the client into "./data/reid_prepare", and copy 1 of them into "./data/reid_robot" as the comparison image.
# preprocessing result: ./data/training_set, ./data/test_set, ./data/reid_prepare, ./data/reid_robot.
